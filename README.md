...
| E, ν, σ<sup>Y</sup> | 15 GPa, 0.30, — (elastic) | 90 GPa, 0.22, 1.5 GPa |
...
| **Critical radius R<sup>crit</sup>** (a = 0.1R) | **28.1 µm** (commercial 5–15 µm → safe) | **331 nm** (experimental window 150–300 nm) |
...
Sensitivity of the silicon R<sup>crit</sup>: E, Ω, K<sub>IC</sub> at ±20 % → 296–366 nm;
σ<sup>Y</sup> → 324–347 nm; D → 305–354 nm; flaw depth a = 0.05–0.2R → 280–405 nm.
The result is robust — the correction, not parameter tuning, brings R<sup>crit</sup>
...
surface stays pinned at −σ<sup>Y</sup>.*
...
*Peak hoop stress meets the fracture strength σ<sub>f</sub>(R) at R<sup>crit</sup>;
...
**6 · Sensitivity of the silicon R<sup>crit</sup>**
...
*Every material parameter moved ±20 %, plus flaw depth a = 0.05–0.2R. R<sup>crit</sup>
...
- **Plastic correction.** Where the elastic trial field violates the Tresca yield
  ...
  (σ<sub>θ</sub> − σ<sub>r</sub> = ±σ<sup>Y</sup>). Its interface radius r<sub>p</sub>
...
- **Fracture.** Griffith surface-flaw strength σ<sub>f</sub> = K<sub>IC</sub> / √(aπR)
  with flaw depth a = 0.1R. R<sup>crit</sup> is where peak σ<sub>θ</sub>(R) =
...
- Material properties are constant (D, E, ν, Ω, K<sub>IC</sub>, σ<sup>Y</sup>) — no
  ...
  silicon R<sup>crit</sup> (296–366 nm).
